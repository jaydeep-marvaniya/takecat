...
<div class="container">
    ...
    <div class="span7">
      <p>Test Details</p>
      <div class="well">
        <p>Name of the test : <?php echo $test[0]['testname'];  ?></p>
    ...
    <div class="row span12">
	<a href="<?php echo $this->config->base_url("account/taketestfinal"); ?>/<?php echo $test[0]['testid'] ?>">
	<button class="btn btn-large btn-primary offset5"  type="Button">Take Test</button></a>
    </div>
    </div>
    </div>
...
<h1> Examinee homepage</h1>
		<a href="<?php echo  $this->config->base_url(); ?>account/taketestfinal "> Take test Final</a></br>

<img alt="" src="<?php echo $this->config->base_url(); ?>assets/images/done/examineetaketest.png"></img>
</br>
