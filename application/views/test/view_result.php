...
<title>  </title>
		<link href="<?php echo $this->config->base_url("assets/teststyle/teststyle.css");?>" type="text/css" media="screen" rel="stylesheet">
...
<script type="text/javascript" src="<?php echo $this->config->base_url("assets/teststyle/control.js");?>"></script>
	<div id="divLoaderImage" style="width: 100%; margin: 0px auto; text-align: center"></div>


	<div class="container2" id="divMainContainer" style="border: none;">

		<div class="content-left3">
	<div style="float: left;">	<h6>Total Questions:
				Total Marks: 
				 Total&nbsp;Time: minuts </h6> </div>
			<div class="section2">
				<h1>
					<strong style="color: #024588; font-size: 24px; font-weight: bold;"> 		</strong>
				</h1>
			</div>
			<div class="clear"></div>
			<div style="" class="sectionDiv">
				...
				<div id="divSections" style="float: left; margin-right: 10px;"><div class="active" onclick="App.showSection(3)">
CHEMISTRY
</div></div>
				<div class="attempt">
					Attempted : <strong id="strongAttemptedQuestions">0</strong>
					Questions
				</div>
			</div>
		</div>
		<div class="content-right3">
			...
			<div class="user">
				<img src="./CT-T-1103_files/user.png" width="30" height="30px" align="left" style="margin-right: 15px">
			</div>
			<div class="time-left">
				<span id="spanWelcome">Welcome, USER</span>
				<div class="clear"></div>
				<div>
					TIME LEFT: <span id="spanTimeLeft"></span> 
				</div>
			</div>
		</div>
		<div class="clear"></div>
		<div class="content3" id="content3">
		 ...
		 <?php foreach ($solution as $solution_item): ?>
	
			<div class="text-left3">
				<div class="text-left3-inner" id="divLeftContainer">
					<div id="divQuestion"><div class="content-title"></div>

					
					<div class="clear"></div>


<table cellspacing="1px" width="100%"><tbody><tr><td valign="top" width="50%"><a name="RESULT TABLE">Question No: <?php echo  $solution_item['priority']+1; ?></a></td></tr></tbody></table>
<br><br>
<table width="100%" style="border-style: solid; border-width: 1px;"     >
<tbody><tr>
<td colspan="4">  <?php echo $solution_item['question'];?> </td></tr>
<tr><td colspan="4" align="right">  Marks: <?php $solution_item['marks'] ?> </td></tr>
<tr><td colspan="4" >  Your answer      <?php echo $solution_item['user_ans'] ?> </td></tr>
<tr><td colspan="4" >  Correct answer   <?php echo $solution_item['answer'] ?> </td></tr>
<tr> <td colspan="4">  Result: 
    	<img src="<?php if ($solution_item['answer'] == $solution_item['user_ans']) { echo $this->config->base_url("assets/images/8.png");   }  
						else echo $this->config->base_url("assets/images/10.png");  ?> " width="100px" height="60px" ">
    	</td> </tr>

<tr><td colspan="4" >  Explanation    <?php echo $solution_item['explanation'] ?></td></tr>

	
	
</tbody></table>
<div id="divResetLink"></div></div>
					<div style="text-align: center" class="content-button">
			...
			<div class="clear"></div>
			<div class="title2">
				<!--<input type="button" id="btnMarkForReview" value="Mark for Review"
					name="" class="button" /> <input type="button" id="btnSkip" value="Skip" name="" class="button" />
				<input type="button" id="btnSaveAndSkip" value="Save &amp; Next" class="button"
					name="" />-->
			</div>
			...
			<div class="text-right3">
				...
				<div class="ques-title">
					You are taking test from <strong id="strongTitle" style="color: #000">ADD THIS</strong>
					Section
				</div>
				...
				<div class="iframe2" id="divQuestionTable"><table cellpadding="0" cellspacing="0" class="ques" width="200">



				<img src="<?php echo  $this->config->base_url("assets/images/results.jpg");  ?>"  >


<tbody>

<table>
<tr> <td> Test:</td><td> <?php echo $result_item[0]['testname'] ?> </td> </tr>
<tr> <td>  Max. Marks:</td><td> <?php echo $result_item[0]['TOTAL_MAX_MARKS'] ?> </td> </tr>
<tr> <td> Your Marks:</td><td> <?php echo $result_item[0]['TOTAL_MARKS'] ?> </td> </tr>
<tr> <td> Your Percentage :</td><td> <?php echo $result_item[0]['PERCENTAGE'] ?> </td> </tr>
<tr> <td> Average Percentage :</td><td> <?php echo $result_item[0]['avg_percentage'] ?> </td> </tr>
<tr> <td> Total Questions: </td><td><?php echo $result_item[0]['total_question'] ?> </td> </tr>
<tr> <td> Attempted Question:</td><td> <?php echo $result_item[0]['ATTEMPTED_QUESTION'] ?> </td> </tr>
<tr> <td> Positive Marks:</td><td> <?php echo $result_item[0]['TOTAL_POSITIVE_MARKS'] ?> </td> </tr>
<tr> <td> Negetive Marks:</td><td> <?php echo $result_item[0]['TOTAL_NEGETIVE_MARKS'] ?> </td> </tr>
<tr> <td> Your Marks:</td><td> <?php echo $result_item[0]['TOTAL_MARKS'] ?> </td> </tr>
