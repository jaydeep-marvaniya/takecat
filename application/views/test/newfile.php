...
<script type="text/javascript" src="<?php echo $this->config->base_url("assets/teststyle/control.js");?>"></script>
	...
	<div style="float: left;">	<h6>Total Questions:<?php echo $test[0]['total_question']; ?>
				Total Marks: <?php echo $test[0]['MAX_MARKS']; ?>
				 Total&nbsp;Time: <?php echo $test[0]['test_max_time_min'] ?> minuts </h6> </div>
			<div class="section2">
				<h1>
					<strong style="color: #024588; font-size: 24px; font-weight: bold;"> 	<?php echo $test[0]['testcode'];?>			</strong>
				</h1>
			</div>
			<div class="clear"></div>
...
CHEMISTRY
		...
		<div class="content-right3">
			...
			<div class="time-left">
				<span id="spanWelcome">Welcome,  <?php echo 'user'; ?>				</span>
				<div class="clear"></div>
				<div>
...
<table cellspacing="5px" width="100%"><tbody><tr><td valign="top" width="50%"><a name="<?php echo $question_item['qid']; ?>">Question No: <?php echo  ($question_item['priority'])+1; ?></a></td></tr></tbody></table>

<table width="100%">
<tbody><tr>
<td colspan="4">  <?php echo $question_item['question'];?> </td></tr>
<tr><td colspan="4">&nbsp;</td></tr>
<tr><td><strong>Answer:</strong></td><td colspan="3">&nbsp;</td></tr>
<tr>
<td width="1%">&nbsp;</td><td width="1%">A</td><td width="1%"><input type="radio" name='<?php echo $question_item['qid']?>' value="A" onchange="App.handleRadioChange(this)"></td>
	</tr>
<tr>
<td width="1%">&nbsp;</td><td width="1%">B</td><td width="1%"><input type="radio" name='<?php echo $question_item['qid']?>'  value="B" onchange="App.handleRadioChange(this)"></td>
	</tr>
<tr>
<td width="1%">&nbsp;</td><td width="1%">C</td><td width="1%"><input type="radio" name='<?php echo $question_item['qid']?>'  value="C" onchange="App.handleRadioChange(this)"></td>
	</tr>
<tr>
<td width="1%">&nbsp;</td><td width="1%">D</td><td width="1%"><input type="radio" name='<?php echo $question_item['qid']?>'  value="D" onchange="App.handleRadioChange(this)"></td>
...
<tr><td colspan="4" align="right">  Marks: <?php $question_item['marks'] ?> </td></tr>
</tbody></table>
<div id="divResetLink"></div></div>
					<div style="text-align: center" class="content-button">
						<input type="button" id="MFR-<?php echo $question_item['qid']?>" value="Mark for Review" name="" class="button">
						
						<script type="text/javascript">
 
    $("#MFR-<?php echo $question_item['qid']?>").click(function () {
 
	  $('#<?php echo $question_item['qid']?>').toggleClass('leg_mark');
			...
			<div class="text-right3">
				...
				<div class="ques-title">
					You are taking test from <strong id="strongTitle" style="color: #000"><?php echo $test[0]['topicname']; ?></strong>
					Section
				</div>
...
<?php 
	...
	for ($c=0; $c<$coloumns && $a<$Noofquestion ; $c++)
	{
	 ...
	 echo	"<td><span class=\"leg_not_vis\" id=".$question[$a]['qid']. ">";
	 echo	"<a href=\"#". $question[$a]['qid']." \">". $question[$a]['priority']."</a></span></td>";
	$a=$a+1;
	}
		echo "</tr>";
...
?>
				...
				<div class="legend">
					<span class="leg_ans"></span> Attempted
				</div>
				
				<div class="legend">
					<span class="leg_mark"></span> Marked
				</div>
				
				<div class="title">
					 <input type="submit"  id="btnSubmit" value="Submit" name="" class="button3"/>
				</div>
			</div>
