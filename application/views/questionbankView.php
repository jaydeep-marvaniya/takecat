...
<table class="table table-bordered">
          ...
          <tr>
            ...
            <td> </td>
            <td> </td>
            <td><a href="<?php echo $this->config->base_url('account/pastresult'); ?>"><button class="btn btn-mini" type="button">delete</button></a></td>
...
<h1> Student QuestionBank</h1>
		<a href="<?php echo  $this->config->base_url(); ?>account/pastresult "> Past result</a></br>
	

<img alt="" src="<?php echo $this->config->base_url(); ?>assets/images/done/studentTakeTestBank.png"></img>
</br>
