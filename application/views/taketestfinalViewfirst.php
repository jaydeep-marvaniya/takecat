...
<form action="<?php echo  $this->config->base_url("account/next_question"); ?>/<?php echo $testid; ?>/<?php echo $question[0]['uid']; ?>/<?php echo $counter; ?>" method="post">
    ...
    <div class="span8">
      <h3   > <?php echo $test[0]['testname']; ?> </h3>
          <div class="well">
 ...
 <a href="<?php echo  $this->config->base_url("account/next_question"); ?>/<?php echo $testid; ?>/<?php echo $question[0]['uid']; ?>"><button class="btn btn-large btn-primary offset4" >Submit</button></a>
